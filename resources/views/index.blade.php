...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            body {
                background-image: url("{{ asset('storage/fondo2.jpg')}}");
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent">
                <a class="navbar-brand" href="#">Tattoos By Pollo</a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                  <div class="navbar-nav">
                    ...
                    <a class="nav-link" href="{{ route('tattoos') }}">
                          Tattoos
                    </a>
                    <a class="nav-link" href="{{ route('pinturas') }}">
                          Pinturas
                    </a>
                    <a class="nav-link" href="{{ route('cotizar') }}" tabindex="-1" aria-disabled="false">
                          Cotizar
                    </a>
                  </div>
                </div>
